...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">No Voto</h3>
				...
				?>
				<a href="voters.php" class = "btn btn-primary btn-outline">Todos los Votadores (<?php echo $count['total']?>)</a>
				<a href="voted.php" class = "btn btn-success btn-outline"> Voto(<?php echo $count1['total']?>)</a>
				<a href="unvoted.php" class = "btn btn-danger btn-outline">No voto(<?php echo $count2['total']?>) </a>
				<br/>
                <!-- /.col-lg-12 -->
