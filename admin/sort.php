            ...
            <div class="row">
				...
				<hr/>
					...
					<div class="panel-heading">
						...
						<a href = "canvassing.php" id="back" class = "btn btn-warning" ><i class = "fa fa-refresh"> </i>Regresar</a>
						<button onclick="window.print();" style = "margin-right:14px; margin-bottom:12px;" id ="print" class = "pull-right btn btn-info"><i class = "fa fa-print"></i> Imprimir</button>	
                            <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover ">
					<thead>
						<td style = "width:600px;" class = "alert alert-success">Candidato</td>
