<div class="modal fade" id="delete_admin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
											...
											<h4 class="modal-title" id="myModalLabel">         
												<div class="panel panel-primary">
													<div class="panel-heading">
														<center>Eliminar Usuario</center>
													</div>    
												</div>
											</h4>
										</div>
										...
										Estas seguro que quieres eliminar la informacion de este usuario ? 
                                    </div>
									
									<div class="modal-footer">
								<a class="btn btn-danger" href="delete_user.php<?php echo '?user_id='.$user_id; ?>"><i class="icon-check"></i>&nbsp;Si</a>
